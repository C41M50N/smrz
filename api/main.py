...
## OUTPUT SECTIONS
1. You extract a summary of the content in 30 words or less, including who is presenting and the content being discussed into a section called "summary". Do not introduce the summary with the word "summary" or any other word. Just write the summary.
...
5. Do not output the "summary" section header; only the paragraph content.
6. You use bullets (`-`), not numbered lists.
7. Do not repeat ideas, or quotes.
8. Do not start items with the same opening words.
"""
